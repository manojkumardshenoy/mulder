...
LangString MPLAYER_LANG_SELECT_CPU_HINT          ${LANG_ENGLISH} "Note: Selecting an incompatible CPU type can lead to a crash on your computer. Please select the 'Generic' type, if in doubt!"
