...
LangString MPLAYER_LANG_DL_ABORTED               ${LANG_ENGLISH} "Download was aborted!"
LangString MPLAYER_LANG_DL_COMPELETED            ${LANG_ENGLISH} "Download completed."
LangString MPLAYER_LANG_DL_ERROR                 ${LANG_ENGLISH} "Error"
LangString MPLAYER_LANG_DL_FAILED                ${LANG_ENGLISH} "Download has failed!"
LangString MPLAYER_LANG_DL_FAILED_MSG            ${LANG_ENGLISH} "Download has failed:"
LangString MPLAYER_LANG_DL_PROGRESS              ${LANG_ENGLISH} "Download in progress, please wait..."
LangString MPLAYER_LANG_DL_RESTARTING            ${LANG_ENGLISH} "Restarting download..."
LangString MPLAYER_LANG_DL_RETRY                 ${LANG_ENGLISH} "Please check your internet connection and try again!"
...
LangString MPLAYER_LANG_SHORTCUT_UPDATE          ${LANG_ENGLISH} "Check for new Updates"
...
LangString MPLAYER_LANG_TAG_WRITE                ${LANG_ENGLISH} "Failed to write version tag! File still in use?"
...
LangString MPLAYER_LANG_UPD_ACCESS_RIGHTS        ${LANG_ENGLISH} "Make sure you have the required access rights and try again!"
LangString MPLAYER_LANG_UPD_ERR_GNUPG            ${LANG_ENGLISH} "Failed to verify signature. GnuPG encountered an error. Aborting!"
LangString MPLAYER_LANG_UPD_ERR_LAUNCH           ${LANG_ENGLISH} "Failed to launch the installer:"
LangString MPLAYER_LANG_UPD_ERR_UPDINFO          ${LANG_ENGLISH} "Failed to read update info. Appears to be incomplete. Aborting!"
LangString MPLAYER_LANG_UPD_ERR_VERIFY           ${LANG_ENGLISH} "Failed to verify signature. Download may be corrupted. Aborting!"
LangString MPLAYER_LANG_UPD_ERR_VERINFO          ${LANG_ENGLISH} "Failed to read local version info. Aborting!"
LangString MPLAYER_LANG_UPD_FAILED               ${LANG_ENGLISH} "Update did NOT complete successfully. Try again now?"
LangString MPLAYER_LANG_UPD_INSTALLED_VER        ${LANG_ENGLISH} "Installed version:"
LangString MPLAYER_LANG_UPD_LATEST_VER           ${LANG_ENGLISH} "Latest version available:"
LangString MPLAYER_LANG_UPD_MIRROR               ${LANG_ENGLISH} "Selected update mirror:"
LangString MPLAYER_LANG_UPD_NO_UPDATES           ${LANG_ENGLISH} "There currently are no new updates available!"
LangString MPLAYER_LANG_UPD_STATUS_DOWNLOAD      ${LANG_ENGLISH} "Downloading updates, please wait..."
LangString MPLAYER_LANG_UPD_STATUS_FAILED        ${LANG_ENGLISH} "Update has failed."
LangString MPLAYER_LANG_UPD_STATUS_INSTALL       ${LANG_ENGLISH} "Installing update, please wait..."
LangString MPLAYER_LANG_UPD_STATUS_MIRROR        ${LANG_ENGLISH} "Selecting update mirror, please wait..."
LangString MPLAYER_LANG_UPD_STATUS_UPDINFO       ${LANG_ENGLISH} "Downloading update information, please wait..."
LangString MPLAYER_LANG_UPD_STATUS_VERINFO       ${LANG_ENGLISH} "Reading local version info, please wait..."
