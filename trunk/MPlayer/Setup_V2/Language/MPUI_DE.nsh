...
LangString MPLAYER_LANG_DL_RETRY                 ${LANG_GERMAN} "Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es noche einmal!"
...
LangString MPLAYER_LANG_UPD_ERR_VERIFY           ${LANG_GERMAN} "Fehler beim Überprüfen der Signatur. Der Download könnte bösartig sein. Abbruch!"
