...
LangString MPLAYER_LANG_SELECT_CPU_HINT          ${LANG_GERMAN} "Hinweis: Ein inkompatibler CPU-Typ kann zum Absturz auf Ihrem Computer führen. Wählen Sie bitte den 'Generic' Typ aus, falls Sie unsicher sind!"
