...
!define Map.Load "!insertmacro _NSISList.Map.Load"
!define Map.Get "!insertmacro _NSISList.Map.Get"
!define Map.Save "!insertmacro _NSISList.Map.Save"
...
!macro _NSISList.Map.Load name dir file_name
  !ifndef _NSISList.TempVar
    !define _NSISList.TempVar
    Var /GLOBAL _NSISList.Temp
  !endif
  NSISList::Load /NOUNLOAD '_Map.Keys::${name}' '${dir}\${file_name}.key'
  Pop $_NSISList.Temp
  StrCmp $_NSISList.Temp "__ERROR" +6
  NSISList::Load /NOUNLOAD '_Map.Data::${name}' '${dir}\${file_name}.dat'
  Pop $_NSISList.Temp
  NSISList::Count /NOUNLOAD '_Map.Keys::${name}'
  Pop $_NSISList.Temp
  NSISList::Dim /NOUNLOAD '_Map.Data::${name}' $_NSISList.Temp
!macroend
...
!macro _NSISList.Map.Save name dir file_name
  !ifndef _NSISList.TempVar
    !define _NSISList.TempVar
    Var /GLOBAL _NSISList.Temp
  !endif
  NSISList::Save /NOUNLOAD '_Map.Keys::${name}' '${dir}\${file_name}.key'
  Pop $_NSISList.Temp
  StrCmp $_NSISList.Temp "__ERROR" +3
  NSISList::Save /NOUNLOAD '_Map.Data::${name}' '${dir}\${file_name}.dat'
  Pop $_NSISList.Temp
!macroend
