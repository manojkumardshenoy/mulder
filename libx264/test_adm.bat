...
"%StdLoggerFolder%\logger.exe" -log "%OutputFoldr%\%CurrentName%.log" -filter "Done:" -format full : "%AvidemuxFolder%\avidemux2_cli.exe" --run "%CD%\test_adm.js" --save "%OutputFoldr%\%CurrentName%.avi"
